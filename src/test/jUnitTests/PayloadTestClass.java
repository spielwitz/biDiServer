...
public class PayloadTestClass
{
	public ArrayList<PayloadTestClass2> subObjects;
	private UUID id;
	
	public PayloadTestClass()
	{
		this.id = UUID.randomUUID();
		
		this.subObjects = new ArrayList<PayloadTestClass2>();
		
		for (int i = 0; i < 5; i++)
			this.subObjects.add(new PayloadTestClass2());
	}
