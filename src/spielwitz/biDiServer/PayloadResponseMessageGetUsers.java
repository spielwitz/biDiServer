...
/**
* Response message payload for getting all users.
* @author spielwitz
*
*/
public class PayloadResponseMessageGetUsers extends PayloadMessageBase
{
	 ...
	 */
	PayloadResponseMessageGetUsers(ArrayList<User> users)
	{
		super();
		this.users = users;
	}
